...
<nav class="navbar navbar-expand-md navbar-light bg-ligth-dark shadow-sm">
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav me-auto ">
				...
				<li class="nav-item">
					<a class="nav-link text-danger " href="{{ route('admin.posts.index') }}">Posts</a>
				</li>
				<li class="nav-item">
					<a class="nav-link text-danger" href="{{ route('admin.posts.create') }}">Create</a>
				</li>
				</li>
			</ul>
